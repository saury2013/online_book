...
def user():
    ...
    return  render_template("admin/user/tf_index.html", users = users)
...
def user_new():
    ...
    return render_template("admin/user/tf_new.html", form=form)
...
def user_detail(id):
    ...
    if form.validate_on_submit():
        ...
        flash("修改成功")
    return render_template("admin/user/tf_detail.html", user=user,
        form=form)